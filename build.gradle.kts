 ...
 *
 * Only MtkPdInfoRoot comes out of this. It is the same code either way: which
...
android {
     ...
     * org.witaqua.mtk.pd_info.R and has to keep finding it.
     */
    namespace = "org.witaqua.mtk.pd_info"
    compileSdk = 35
    ...
    defaultConfig {
         ...
         * it to compare.
         */
        applicationId = "org.witaqua.mtk.pd_info.root"
        minSdk = 31
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    applicationVariants.all {
        outputs.all {
            (this as com.android.build.gradle.internal.api.BaseVariantOutputImpl)
                .outputFileName = "MtkPdInfoRoot.apk"
        }
    }
}
